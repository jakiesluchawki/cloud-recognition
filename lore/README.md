...
> Auto-generated on 2026-06-16 10:34. Do not edit manually.
...
- **Task 0007**: [Add multi-report briefings and spaced review](lore/1-tasks/active/0007_FEATURE_briefing-review-training.md) — blocks 0 tasks (low)

## Task Status

| ID | Title | Type | Status | Blocked By | Blocks | ADRs |
|:---|:------|:-----|:-------|:-----------|:-------|:-----|
| 0007 | [Add multi-report briefings and spac...](lore/1-tasks/active/0007_FEATURE_briefing-review-training.md) | FEATURE | **active** | — | — | — |
